package com.linksteady.common.aspect;

import com.linksteady.common.annotation.Limit;
import com.linksteady.common.domain.LimitType;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.linksteady.common.annotation.Limit)")

...
function getPlanEffectInfo(kpiType) {
    $.get("/qywxActivityPlan/getPlanEffectInfo", {planId: planId,kpiType:kpiType}, function (r) {
        let data = r.data;
...
function makePushChart() {
    $.get("/qywxActivityPlan/getPlanEffectTrend", {planId: planId}, function (r) {
        let data = r.data;
...
function getEffectPersonalPage() {
    var settings = {
        url: '/qywxActivityPlan/getPersonalPlanEffect',
        pagination: true,
        singleSelect: true,
...
$("#backBtn").click(function () {
    window.location.href = "/page/qywxActivity/backToPlanList?planId=" + planId;
});

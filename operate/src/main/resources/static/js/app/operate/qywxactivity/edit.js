...
function updateData(actType, startDt, endDt, dateRange) {
    $.get("/qywxActivity/updateData", {headId:headId, actType: actType, startDt:startDt, endDt:endDt, dateRange: dateRange}, function (r) {
        console.log(r);
    });
}
...
function getDataById() {
    $MB.loading('show');
    $.get("/qywxActivity/getDataById", {headId: headId}, function (r) {
        var data = r.data;

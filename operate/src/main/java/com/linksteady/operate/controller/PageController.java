...
//        return "redirect:/page/qywxDaily/list";
    ...
    public String goCustomerBase(){
        return  "operate/customerBaseList/Baselist";
    }
    ...
    public String goBaseMsg(){
        return  "operate/customerBaseSend/BaseSendMsg";
    }
    ...
    public String goBaseSop(){
        return  "operate/groupSOP/BaseSOP";
    }
    ...
    public String goPullGroup(){
        return  "operate/autoPullGroup/PullGroup";
    }
    ...
    public String goAddGroup(){
        return  "operate/autoPullGroup/addGroup";
    }
    ...
    public String goTagGroup(){
        return  "operate/tagGroup/tagGroupList";
    }
    ...
    public String addTagGroup(){
        return  "operate/tagGroup/addTagGroup";
    }
    ...
    public String goGroupCalendar(){
        return "operate/groupCalendar/groupCalendarList";
    }
    ...
    public String addGroupCalendar(){
        return "operate/groupCalendar/addGroupCalendar";
    }

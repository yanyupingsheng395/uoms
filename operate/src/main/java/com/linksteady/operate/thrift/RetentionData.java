...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.11.0)", date = "2019-12-18")
public class RetentionData implements org.apache.thrift.TBase<RetentionData, RetentionData._Fields>, java.io.Serializable, Cloneable, Comparable<RetentionData> {
  ...
  public java.util.List<java.lang.Double> retentionFit; // required
  public java.util.List<java.lang.Double> retentionChangeFit; // required
  ...
  public RetentionData(
          java.util.List<java.lang.Double> retentionFit,
          java.util.List<java.lang.Double> retentionChangeFit)
  {
    this();
  ...
  public RetentionData(RetentionData other) {
    if (other.isSetRetentionFit()) {
      java.util.List<java.lang.Double> __this__retentionFit = new java.util.ArrayList<java.lang.Double>(other.retentionFit);
      this.retentionFit = __this__retentionFit;
    }
    if (other.isSetRetentionChangeFit()) {
      java.util.List<java.lang.Double> __this__retentionChangeFit = new java.util.ArrayList<java.lang.Double>(other.retentionChangeFit);
  ...
  public java.util.Iterator<java.lang.Double> getRetentionFitIterator() {
  ...
  public void addToRetentionFit(double elem) {
    if (this.retentionFit == null) {
      this.retentionFit = new java.util.ArrayList<java.lang.Double>();
    }
    this.retentionFit.add(elem);
  }

  public java.util.List<java.lang.Double> getRetentionFit() {
    return this.retentionFit;
  }

  public RetentionData setRetentionFit(java.util.List<java.lang.Double> retentionFit) {
    this.retentionFit = retentionFit;
    return this;
  }
  ...
  public java.util.Iterator<java.lang.Double> getRetentionChangeFitIterator() {
  ...
  public void addToRetentionChangeFit(double elem) {
    if (this.retentionChangeFit == null) {
      this.retentionChangeFit = new java.util.ArrayList<java.lang.Double>();
    }
    this.retentionChangeFit.add(elem);
  }

  public java.util.List<java.lang.Double> getRetentionChangeFit() {
    return this.retentionChangeFit;
  }

  public RetentionData setRetentionChangeFit(java.util.List<java.lang.Double> retentionChangeFit) {
    this.retentionChangeFit = retentionChangeFit;
    return this;
  }
    ...
    switch (field) {
      case RETENTION_FIT:
        if (value == null) {
          ...
          setRetentionFit((java.util.List<java.lang.Double>)value);
        }
        break;
      ...
      case RETENTION_CHANGE_FIT:
        if (value == null) {
          ...
          setRetentionChangeFit((java.util.List<java.lang.Double>)value);
        }
        break;
  ...
  public int compareTo(RetentionData other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRetentionFit()).compareTo(other.isSetRetentionFit());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRetentionChangeFit()).compareTo(other.isSetRetentionChangeFit());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRetentionChangeFit()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("RetentionData(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.retentionFit = new java.util.ArrayList<java.lang.Double>(_list0.size);
                double _elem1;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.retentionChangeFit = new java.util.ArrayList<java.lang.Double>(_list3.size);
                double _elem4;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.retentionFit = new java.util.ArrayList<java.lang.Double>(_list10.size);
          double _elem11;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.retentionChangeFit = new java.util.ArrayList<java.lang.Double>(_list13.size);
          double _elem14;

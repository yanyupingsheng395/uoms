package com.linksteady.jobmanager.service.impl;

import com.linksteady.jobmanager.aspect.CronTag;
import com.linksteady.jobmanager.domain.Job;
import com.linksteady.jobmanager.dao.JobMapper;
import com.linksteady.jobmanager.service.JobService;
import com.linksteady.jobmanager.util.ScheduleUtils;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public void addJob(Job job) {
        job.setJobId(jobMapper.getJobSeqId());
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("com.linksteady.jobmanager.task");

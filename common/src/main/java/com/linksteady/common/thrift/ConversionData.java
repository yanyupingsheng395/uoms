...
public class ConversionData implements org.apache.thrift.TBase<ConversionData, ConversionData._Fields>, java.io.Serializable, Cloneable, Comparable<ConversionData> {
  ...
  public java.util.List<java.lang.Double> xdata; // required
  public java.util.List<java.lang.Double> ydata; // required
  public java.util.List<java.lang.Double> zdata; // required
  ...
  public ConversionData(
          ...
          java.util.List<java.lang.Double> xdata,
          java.util.List<java.lang.Double> ydata,
          java.util.List<java.lang.Double> zdata)
  {
    this();
    this.type = type;
    this.xdata = xdata;
  ...
  public ConversionData(ConversionData other) {
    ...
    if (other.isSetXdata()) {
      java.util.List<java.lang.Double> __this__xdata = new java.util.ArrayList<java.lang.Double>(other.xdata);
      this.xdata = __this__xdata;
    }
    if (other.isSetYdata()) {
      java.util.List<java.lang.Double> __this__ydata = new java.util.ArrayList<java.lang.Double>(other.ydata);
      this.ydata = __this__ydata;
    }
    if (other.isSetZdata()) {
      java.util.List<java.lang.Double> __this__zdata = new java.util.ArrayList<java.lang.Double>(other.zdata);
  ...
  public ConversionData setType(java.lang.String type) {
    this.type = type;
    return this;
  }
  ...
  public java.util.Iterator<java.lang.Double> getXdataIterator() {
    return (this.xdata == null) ? null : this.xdata.iterator();
  }

  public void addToXdata(double elem) {
    if (this.xdata == null) {
      this.xdata = new java.util.ArrayList<java.lang.Double>();
    }
    this.xdata.add(elem);
  }
  ...
  public ConversionData setXdata(java.util.List<java.lang.Double> xdata) {
    this.xdata = xdata;
    return this;
  }
  ...
  public java.util.Iterator<java.lang.Double> getYdataIterator() {
    return (this.ydata == null) ? null : this.ydata.iterator();
  }

  public void addToYdata(double elem) {
    if (this.ydata == null) {
      this.ydata = new java.util.ArrayList<java.lang.Double>();
    }
    this.ydata.add(elem);
  }
  ...
  public ConversionData setYdata(java.util.List<java.lang.Double> ydata) {
    this.ydata = ydata;
    return this;
  }
  ...
  public java.util.Iterator<java.lang.Double> getZdataIterator() {
    return (this.zdata == null) ? null : this.zdata.iterator();
  }

  public void addToZdata(double elem) {
    if (this.zdata == null) {
      this.zdata = new java.util.ArrayList<java.lang.Double>();
    }
    this.zdata.add(elem);
  }

  public java.util.List<java.lang.Double> getZdata() {
    return this.zdata;
  }

  public ConversionData setZdata(java.util.List<java.lang.Double> zdata) {
    this.zdata = zdata;
    return this;
  }
    ...
    switch (field) {
      ...
      case XDATA:
        if (value == null) {
          ...
          setXdata((java.util.List<java.lang.Double>)value);
        }
        break;
      ...
      case YDATA:
        if (value == null) {
          ...
          setYdata((java.util.List<java.lang.Double>)value);
        }
        break;
      ...
      case ZDATA:
        if (value == null) {
          ...
          setZdata((java.util.List<java.lang.Double>)value);
        }
        break;
  ...
  public int compareTo(ConversionData other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetXdata()).compareTo(other.isSetXdata());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetXdata()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetYdata()).compareTo(other.isSetYdata());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetYdata()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetZdata()).compareTo(other.isSetZdata());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetZdata()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ConversionData(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.xdata = new java.util.ArrayList<java.lang.Double>(_list16.size);
                double _elem17;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ydata = new java.util.ArrayList<java.lang.Double>(_list19.size);
                double _elem20;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.zdata = new java.util.ArrayList<java.lang.Double>(_list22.size);
                double _elem23;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.xdata = new java.util.ArrayList<java.lang.Double>(_list31.size);
          double _elem32;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.ydata = new java.util.ArrayList<java.lang.Double>(_list34.size);
          double _elem35;
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.zdata = new java.util.ArrayList<java.lang.Double>(_list37.size);
          double _elem38;
